...
def delete_exam():
    ...
    try:
        ...
        db.commit()
        return jsonify({"success": True, "message": "Xóa đề và câu hỏi thành công"})
    except Exception as e:
        import traceback
